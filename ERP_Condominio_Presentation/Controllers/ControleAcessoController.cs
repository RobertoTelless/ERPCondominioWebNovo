    ...
    public class ControleAcessoController : Controller
    {
        ...
        public ActionResult Login(UsuarioLoginViewModel vm)
        {
            try
            {
                ...
                if (volta == 1)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0001", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 2)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0002", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 3)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0003", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 5)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0005", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 4)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0004", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 6)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0006", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 7)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0007", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 9)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0073", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 10)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0109", CultureInfo.CurrentCulture));
                    return View(vm);
                }
        ...
        public ActionResult TrocarSenha(UsuarioLoginViewModel vm)
        {
            try
            {
                ...
                if (volta == 1)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0008", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 2)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0009", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 3)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0074", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 4)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0075", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                Session["UserCredentials"] = null;
                return RedirectToAction("Login", "ControleAcesso");
        ...
        public ActionResult GerarSenha(UsuarioLoginViewModel vm)
        {
            try
            {
                ...
                if (volta == 2)
                {
                    ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0110", CultureInfo.CurrentCulture));
                    return View(vm);
                }
                if (volta == 3)
                {
