    ...
    public class TarefaController : Controller
    {
        ...
        public ActionResult IncluirTarefa(TarefaViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (volta == 1)
                    {
                        ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0017", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 2)
                    {
                        ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0018", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
        ...
        public ActionResult EditarTarefa(TarefaViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (volta == 1)
                    {
                        ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0020", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 2)
                    {
                        ModelState.AddModelError("", ERP_Condominio_Resources.ResourceManager.GetString("M0025", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
        ...
        public JsonResult EditarStatusTarefa(Int32 id, Int32 status)
        {
            ...
            try
            {
                ...
                if (volta == 1)
                {
                    return Json(ERP_Condominio_Resources.ResourceManager.GetString("M0020", CultureInfo.CurrentCulture));
                }
                if (volta == 2)
                {
                    return Json(ERP_Condominio_Resources.ResourceManager.GetString("M0025", CultureInfo.CurrentCulture));
                }
